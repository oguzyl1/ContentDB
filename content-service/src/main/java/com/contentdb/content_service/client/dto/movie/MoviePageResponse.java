...
public class MoviePageResponse implements Serializable {
    ...
    private List<MovieCreditsResponse> credits;

    @JsonProperty("recommendations")
    private List<MovieRecommendationResult> recommendations;

    @JsonProperty("translations")
    private List<MovieTranslationsResult> translations;
    ...
    public List<MovieCreditsResponse> getCredits() {
        return credits;
    }

    public List<MovieRecommendationResult> getRecommendations() {
        return recommendations;
    }

    public List<MovieTranslationsResult> getTranslations() {
        return translations;
    }
}
