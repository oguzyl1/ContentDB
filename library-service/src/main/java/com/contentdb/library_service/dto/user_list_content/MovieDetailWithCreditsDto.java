...
public class MovieDetailWithCreditsDto {
    ...
    public MovieDetailWithCreditsDto(MovieDetailResponse details, MovieCreditsResponse credits, List<RecommendationResponse> recommendations, List<TranslationsResponse> translations) {
